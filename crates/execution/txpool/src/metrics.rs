...
base_metrics::define_metrics! {
    ...
    #[describe("Validity (advanced) transactions admitted to the pool, labeled by whether the admission replaced an existing same-sender/nonce transaction or added a new pool entry")]
